				...
				<div className="row">
					<div className="col-lg-3 col-md-6">
						<div className="cta-counter-box">
							...
							<h2><span id="days1" className="time-value">49</span></h2>
						</div>
					...
					<div className="col-lg-3 col-md-6">
						<div className="cta-counter-box">
							<img src="assets/img/elements/elements23.png" alt="" className="elements23 keyframe5" />
							<h2><span id="hours1" className="time-value">49</span></h2>
						</div>
						<div className="space50 d-lg-none d-block"></div>
					</div>
					<div className="col-lg-3 col-md-6">
						<div className="cta-counter-box">
							<img src="assets/img/elements/elements23.png" alt="" className="elements23 keyframe5" />
							<h2><span id="minutes1" className="time-value">49</span></h2>
						</div>
					</div>
					<div className="col-lg-3 col-md-6">
						<div className="cta-counter-box">
							<img src="assets/img/elements/elements23.png" alt="" className="elements23 keyframe5" />
							<h2><span id="seconds1" className="time-value">49</span></h2>
						</div>
					</div>
				</div>
				<div className="row">
