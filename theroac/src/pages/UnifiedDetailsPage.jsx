...
const UnifiedDetailsPage = () => {
    ...
    const typeConfig = {
        ...
        internships: {
            ...
            headerIcon: Clock,
            logoGradient: 'linear-gradient(135deg, #11998e 0%, #38ef7d 100%)',
            priceLabel: 'Stipend'
        }
    };
    ...
    const getJobData = (jobId) => {
        ...
        return jobs[parseInt(jobId) - 1] || jobs[0];
    };
    ...
    const mockData = {
        ...
        events: (() => {
            ...
            return events[parseInt(id) - 1] || events[0];
        })(),
        internships: (() => {
            const programs = [
                {
            ...
            return programs[parseInt(id) - 1] || programs[0];
        })()
    };
    ...
    useEffect(() => {
        const handleScroll = () => {
            if (headerRef.current && leftContentRef.current) {
                ...
                setIsHeaderSticky(leftContentScrollTop > 100);
    ...
    const handleApply = async () => {
        ...
        setIsApplying(true);
        try {
            // Here you would make an API call to apply for the job/event/internship
            console.log(`Applying for ${type}:`, data.id, 'User:', user.id);
    ...
    const getPriceDisplay = () => {
        switch (type) {
            case 'jobs':
                return data.salary || 'Competitive';
            case 'events':
                return 'Free';
            case 'internships':
                return `${data.stipend?.min} - ${data.stipend?.max}` || 'Unpaid';
            default:
                return 'N/A';
        }
    };
    ...
    const getOrganizationName = () => {
        return data.company || data.organization || 'Organization';
    };
                    ...
                    <div ref={headerRef} className="header-card">
                        <div className="header-left">
                            ...
                            <div className="info">
                                ...
                                <div className="meta">
                                    ...
                                    <div className="meta-row">
                                        <Calendar size={16} />
                                        <span>Updated On: {data.posted}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="header-right">
                            <div className="days-left">
                                <span className="days-number">{data.deadline}</span>
                                ...
                                <div className="content-subsection">
                                    ...
                                    <div className="prizes-grid">
                                        ...
                                        <div className="prize-card">
                                            <Wallet size={48} />
                                            <h3>Stipend</h3>
                                            <div className="prize-amount">{data.stipend?.min} - {data.stipend?.max}</div>
                            ...
                            <div id="dates" className="content-section">
                                ...
                                <div className="deadline-item">
                                    ...
                                    <div className="deadline-info">
                                        ...
                                        <span className="deadline-date">{data.deadline} days left</span>
                                    </div>
                                </div>
                            </div>
                        )}
                                ...
                                <>
                                    ...
                                    <div className="stat-item-individual">
                                        ...
                                        <div className="stat-content">
                                            ...
                                            <span className="stat-number">{data.deadline} days left</span>
                                        </div>
                                    </div>
                                </>
                            )}
